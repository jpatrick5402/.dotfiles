...
# install basic apps
sudo pacman -S blueman polybar picom feh git alacritty neovim base-devel fzf ttf-firacode-nerd firefox man clipmenu less bluez bluez-utils pulseaudio pulseaudio-bluetooth pulseaudio-jack --noconfirm
