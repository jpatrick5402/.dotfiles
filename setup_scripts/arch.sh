...
# install basic apps
sudo pacman -S zip unzip autorandr ripgrep rofi npm zsh arandr blueman polybar picom feh git alacritty neovim base-devel fzf ttf-3270-nerd ttf-firacode-nerd firefox man less bluez bluez-utils pulseaudio pulseaudio-bluetooth pulseaudio-jack --noconfirm
