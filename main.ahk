...
:X:_wstill::{
    Send "Hello XXXXXXXX,`rIs this issue still occurring?`rIf you have any questions or need assistance, please call us at (585) 275-3200.`r`r"
    Send WorkSignature
}
:X:_w2::{
...
^!x::Run hpath . "\AppData\Local\Vivaldi\Application\vivaldi.exe"
